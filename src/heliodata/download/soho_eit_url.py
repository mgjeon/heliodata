...
from heliodata.download.util import download_url, get_bs, get_timedelta
...
class SOHOEITDownloader:
    ...
    def get_data_level0(self, soho_url, file_list):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--quality_check', action='store_true', help='perform quality check on the downloaded files.', required=False, default=False)

    args = parser.parse_args()

    downloader = SOHOEITDownloader(ds_path=args.ds_path, n_workers=args.n_workers, quality_check=args.quality_check)
